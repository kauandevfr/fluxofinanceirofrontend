...
export default function Container({ children, amount }) {
    ...
    const stepsByRoute = {
        dashboard: [
            {
                target: '#step-1',
                content: <p>Bem-vindo ao seu painel principal! <br />Aqui você terá um resumo geral das suas finanças.</p>,
                placement: 'center',
                disableBeacon: true
            },
            ...
            {
                target: '#step-2',
                content: <p>Este painel resume sua situação financeira atual: quanto você recebeu, quanto já gastou e o quanto ainda tem disponível.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            ...
            {
                target: '#step-3',
                content: <p>Veja um resumo das despesas e rendas.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            ...
            {
                target: '#step-4',
                content: <p>Para ver tudo, use "Ver mais".</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            ...
            {
                target: '#step-5',
                content: <p>Aqui você vê o total por categoria, forma de pagamento, status e vencimento para acompanhar suas finanças rapidamente.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            ...
            {
                target: '#step-6',
                content: <p>Pelo menu, você pode navegar por todas as páginas, incluindo Painel, Listagens e Cadastros.</p>,
                placement: 'right',
                disableBeacon: true
            },
            ...
            {
                target: '#step-7',
                content: <p>Alterne entre meses e anos para acompanhar a evolução das suas finanças.</p>,
                placement: 'right',
                disableBeacon: true
            },
            ...
            {
                target: '#step-8',
                content: <p>O sistema já possui categorias e formas de pagamento pré-cadastradas, mas você pode editá-las ou adicionar novas a qualquer momento para manter tudo organizado e gerar relatórios detalhados.</p>,
                placement: 'right',
                disableBeacon: true
            },
            ...
            {
                target: '#step-9',
                content: <p>Acesse o perfil para visualizar seus dados e configurar a conta.</p>,
                placement: 'right',
                disableBeacon: true
            },
            {
                target: '#step-1',
                content: <p>Pronto! Agora você concluiu a visão geral do painel. Vamos seguir para o cadastro de despesas para organizar melhor suas finanças.</p>,
                placement: 'center',
                disableBeacon: true
            },
        ],
        expenses: [
            {
                target: '#step-10',
                content: <p>Aqui você visualiza todas as suas despesas organizadas, mantendo suas finanças sob controle.</p>,
                placement: 'top',
                disableBeacon: true
            },
            {
                target: '#step-11',
                content: <p>Adicione uma nova despesa de forma rápida clicando aqui.</p>,
                placement: 'left',
                disableBeacon: true
            },
            {
                target: '#step-12',
                content: <p>Use os filtros para encontrar despesas específicas e personalizar sua visualização.</p>,
                placement: 'left',
                disableBeacon: true
            },
            {
                target: '#step-13',
                content: <p>Nesta seção, você pode ordenar suas despesas para visualizar tudo de forma organizada.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            {
                target: '#step-14',
                content: <p>Pesquise despesas pelo título para agilizar a gestão.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            {
                target: '#step-1',
                content: <p>Apresentação da página de despesas concluída! Agora vamos conhecer a seção de receitas.</p>,
                placement: 'center',
                disableBeacon: true
            },
        ],
        incomes: [
            {
                target: '#step-15',
                content: <p>Aqui você pode adicionar novas receitas para registrar seus ganhos.</p>,
                placement: 'left',
                disableBeacon: true
            },
            {
                target: '#step-16',
                content: <p>Use a pesquisa para encontrar receitas rapidamente pelo título.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            {
                target: '#step-17',
                content: <p>Nesta seção, você pode ordenar suas receitas por título, valor ou data.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            {
                target: '#step-18',
                content: <p>Aqui estão listadas todas as receitas registradas. Você pode editar ou excluir quando quiser.</p>,
                placement: 'bottom',
                disableBeacon: true
            },
            {
                target: '#step-1',
                content: <p>Pronto! O mini tutorial foi concluído com sucesso. Agora você será redirecionado ao painel e já pode começar a usar.</p>,
                placement: 'center',
                disableBeacon: true
            }
        ]
    ...
    return (
        <>
            <Joyride
                ...
                callback={(data) => {
                    const { index, lifecycle, status, action } = data;
                    const steps = stepsByRoute[page];
                    ...
                    if (status === 'finished' || status === 'skipped') {
                        ...
                        if (action === 'next') {
                            if (index + 1 < steps.length) {
                                ...
                                if (page === 'dashboard') {
                                    setStepIndex(0);
                                    redirect(`/expenses/${queryStr}`);
                                } else if (page === 'expenses') {
                                    setStepIndex(0);
                                    redirect(`/incomes/${queryStr}`);
                                } else if (page === 'incomes') {
                                    setStepIndex(0);
                                    redirect(`/dashboard/${queryStr}`);
                                    setInitTutorial(false);
                                } else {
                                    setInitTutorial(false);
                                }
            ...
            <main id="step-1">
                ...
                <aside className={`aside-menu vertical-align gap1 ${viewAside ? "active" : ''}`} data-view-aside={viewAside} id="step-6">
                    ...
                    <form className="vertical-align gap2 w100" onSubmit={(e) => applyPeriod(e)} id="step-7">
                    ...
                    <div className="vertical-align w100 gap2 mb-auto" >
                        ...
                        <div className="vertical-align w100 gap1 ai-start" >
                            ...
                            <button className="button menu" type="button" data-tooltip="Exibir todos os registros" onClick={listAllRecords}>
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <path
                        ...
                        <div className="vertical-align w100 gap1 ai-start" id="step-8">
                    ...
                    <div className="vertical-align gap1">
                        ...
                        <div className="horizontal-align gap1 aside-menu__user-actions" id="step-9">
                ...
                <main className="vertical-align w100 min-h-100vh">
                    ...
                    <section className='p4-0 w83 m0auto vertical-align gap4 jc-between' >
                        <div className="financial-summary horizontal-align gap4 w100" id="step-2">
                ...
                {user.data?.primeiroacesso && <ModalFirstAccess />}
                <ModalDelete />
                <ModalExpense />
                <Alert />
            </main>
